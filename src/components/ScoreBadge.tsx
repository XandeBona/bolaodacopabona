...
export function ScoreBadge({ pontos, size = 'md' }: ScoreBadgeProps) {
  ...
  return (
    <span className={clsx(
      'inline-flex items-center gap-0.5 rounded font-mono font-bold',
      size === 'sm' ? 'px-1.5 py-0.5 text-xs' : 'px-2 py-1 text-sm',
      pontos === 20 && 'bg-purple-500/20 text-purple-300 ring-1 ring-purple-400/40',
      pontos >= 10 && pontos < 20 && 'bg-amber-400/20 text-amber-300 ring-1 ring-amber-400/40',
